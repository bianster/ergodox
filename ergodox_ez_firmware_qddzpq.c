...
[0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_DELETE,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,CTL_T(KC_Z),KC_X,KC_C,KC_V,ALT_T(KC_B),GUI_T(KC_NO),TG(2),KC_GRAVE,LALT(KC_LSHIFT),KC_UP,KC_DOWN,KC_TRANSPARENT,KC_TRANSPARENT,KC_HOME,KC_SPACE,KC_BSPACE,KC_END,KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,TG(1),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_QUOTE,GUI_T(KC_NO),ALT_T(KC_N),KC_M,KC_COMMA,KC_DOT,CTL_T(KC_SLASH),KC_LSHIFT,KC_LEFT,KC_RIGHT,KC_LBRACKET,KC_RBRACKET,TG(2),KC_TRANSPARENT,KC_TRANSPARENT,KC_PGUP,KC_PGDOWN,KC_TAB,KC_ENTER),
